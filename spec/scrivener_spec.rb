...
'
  ...
  def test_should_apply_combinatorics_over_instances_on_sentences
    assert_equal(@scrivener.combinatorics_over_pairs_of_instances(@scrivener.isolate_ids_and_pure_text('<db id=/Anarchism>Anarchism</db> is often defined as a <db id=/Political_philosophy>political philosophy</db> which holds the <db id=/State_(polity)>state</db> to be undesirable, unnecessary, or harmful'), false), ['<Anarchism/Anarchism> is often defined as a <political philosophy/Political_philosophy> which holds the state to be undesirable, unnecessary, or harmful', '<Anarchism/Anarchism> is often defined as a political philosophy which holds the <state/State_(polity)> to be undesirable, unnecessary, or harmful', 'Anarchism is often defined as a <political philosophy/Political_philosophy> which holds the <state/State_(polity)> to be undesirable, unnecessary, or harmful'])

    assert_equal(@scrivener.combinatorics_over_pairs_of_instances(@scrivener.isolate_ids_and_pure_text('Proponents of <db id=/Anarchism>anarchism</db>, known as "anarchists", advocate <db id=/Stateless_society>stateless societies</db> based on non-<db id=/Hierarchy>hierarchical</db> <db id=/Free_association_(communism_and_anarchism)>free associations</db>'), false), ['Proponents of <anarchism/Anarchism>, known as "anarchists", advocate <stateless societies/Stateless_society> based on non-hierarchical free associations', 'Proponents of <anarchism/Anarchism>, known as "anarchists", advocate stateless societies based on non-<hierarchical/Hierarchy> free associations', 'Proponents of <anarchism/Anarchism>, known as "anarchists", advocate stateless societies based on non-hierarchical <free associations/Free_association_(communism_and_anarchism)>', 'Proponents of anarchism, known as "anarchists", advocate <stateless societies/Stateless_society> based on non-<hierarchical/Hierarchy> free associations', 'Proponents of anarchism, known as "anarchists", advocate <stateless societies/Stateless_society> based on non-hierarchical <free associations/Free_association_(communism_and_anarchism)>', 'Proponents of anarchism, known as "anarchists", advocate stateless societies based on non-<hierarchical/Hierarchy> <free associations/Free_association_(communism_and_anarchism)>'] )
  end
  ...
  def test_extract_useful_sentences
    assert_equal(@scrivener.extract_sentences,
                 [['<Anarchism/Anarchism> is often defined as a <political philosophy/Political_philosophy> which holds the state to be undesirable, unnecessary, or harmful', '/philosophy'],
                  ['<Anarchism/Anarchism> as a mass <social movement/Social_movement> has regularly endured fluctuations in popularity', '/partOf'],
                  ["The central tendency of <anarchism/Anarchism> as a <social movement/Social_movement> has been represented by anarcho-communism and anarcho-syndicalism, with individualist anarchism being primarily a literary phenomenon which nevertheless did have an impact on the bigger currents and individualists have also participated in large anarchist organizations", '/partOf']])
  end
end
