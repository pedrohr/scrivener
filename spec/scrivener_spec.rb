...
'
  ...
  def test_should_apply_combinatorics_over_instances_on_sentences
    ...
    assert_equal(@scrivener.combinatorics_over_pairs_of_instances(@scrivener.isolate_ids_and_pure_text('Proponents of <db id=/Anarchism>anarchism</db>, known as "anarchists", advocate <db id=/Stateless_society>stateless societies</db> based on non-<db id=/Hierarchy>hierarchical</db> <db id=/Free_association_(communism_and_anarchism)>free associations</db>'), false),['Proponents of </Anarchism>, known as "anarchists", advocate </Stateless_society> based on non-hierarchical free associations', 'Proponents of </Anarchism>, known as "anarchists", advocate stateless societies based on non-</Hierarchy> free associations', 'Proponents of </Anarchism>, known as "anarchists", advocate stateless societies based on non-hierarchical </Free_association_(communism_and_anarchism)>', 'Proponents of anarchism, known as "anarchists", advocate </Stateless_society> based on non-</Hierarchy> free associations', 'Proponents of anarchism, known as "anarchists", advocate </Stateless_society> based on non-hierarchical </Free_association_(communism_and_anarchism)>', 'Proponents of anarchism, known as "anarchists", advocate stateless societies based on non-</Hierarchy> </Free_association_(communism_and_anarchism)>'] )
  end
